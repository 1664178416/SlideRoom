...
const dictionaries = {
  en: {
    ...
    "settings.tokenPolicyHint": "Uploading never calls the model. AI runs only after a preset or question is submitted.",
    ...
    "settings.deferredAIHint": "Right-side presets and custom questions call your configured API on demand.",
    ...
    "workspace.uploadingDeckHint": "Rendering previews and extracting text/notes. No model call is sent.",
    "rail.slides": "Slides",
    ...
    "slideArt.importedVisualReady": "Page text and speaker notes are ready for slide-level reading and questions.",
    "slideArt.importedVisualPlaceholder": "Preview image is unavailable on this device. You can still use extracted text and speaker notes when available.",
    ...
    "ai.explainHint": "Two tiny margin notes: takeaway and proof.",
    "ai.summaryHint": "One skim note for fast review.",
    "ai.scriptHint": "One tiny presenter line.",
    "ai.reviewHint": "Two tiny checks: risk and question.",
    "ai.preset": "Preset",
    ...
    "ai.noModelCallYet": "No model call has been sent yet. This preset will run only after you press Generate.",
  ...
  zh: {
    ...
    "workspace.uploadingDeckHint": "渲染页面并提取文字/备注，不会调用模型。",
    "rail.slides": "幻灯片",
    "rail.thumbnails": "缩略图",
    "rail.outline": "大纲",
    ...
    "slideArt.importedVisualReady": "页面文字和讲者备注已可用于逐页阅读和提问。",
    "slideArt.importedVisualPlaceholder": "当前设备未生成页面预览；如有文字或备注，仍可用于提问。",
    ...
    "ai.scriptShort": "讲稿",
    "ai.reviewShort": "审阅",
    "ai.explainHint": "两条极短旁注：结论和依据。",
    "ai.summaryHint": "一句扫读摘要。",
    "ai.scriptHint": "一句短讲稿。",
    "ai.reviewHint": "两条极短审阅：风险和追问。",
    "ai.preset": "预设",
    "ai.runPreset": "生成",
    "ai.generating": "生成中",
    ...
    "ai.noModelCallYet": "还没有发送模型请求；只有点击生成后，当前预设才会调用模型。",
