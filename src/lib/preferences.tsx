...
const dictionaries = {
  en: {
    ...
    "home.processingHint": "Rendering slides, extracting text, and preparing page context.",
    "home.readyHint": "Slides are rendered and ready for the workspace.",
    ...
    "processing.subtitle": "Rendering slides and preparing page context.",
  ...
  zh: {
    ...
    "home.processingHint": "正在渲染幻灯片、提取文字并准备逐页上下文。",
    "home.readyHint": "幻灯片已渲染完成，可以进入工作台。",
    ...
    "processing.convert": "转换",
    "processing.render": "渲染",
    "processing.extract": "提取",
    "processing.index": "索引",
    "processing.ready": "就绪",
    "processing.title": "正在处理演示文稿",
    "processing.subtitle": "正在渲染幻灯片并准备逐页上下文。",
    "processing.file": "文件",
