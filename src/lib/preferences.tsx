...
const dictionaries = {
  en: {
    ...
    "home.sampleReady": "Sample deck ready",
    ...
    "home.sampleReadyHint": "This sample deck is ready. Enter the workspace now or upload your own PPT.",
    ...
    "settings.testPassed": "Connection works. Save to use this configuration.",
    "settings.tokenPolicy": "AI usage",
    "settings.tokenPolicyHint": "Uploading never calls the model. Testing the connection, presets, and questions are the only token-spending actions.",
    ...
    "stage.slide": "Slide",
    "stage.viewer": "Slide viewer",
    "stage.contextPanel": "Slide context",
    "stage.copyNotes": "Copy speaker notes",
    "stage.notesCopied": "Speaker notes copied",
    ...
    "ai.explainHint": "Click to get one margin tag.",
    "ai.summaryHint": "Click to get one skim tag.",
    ...
    "ai.emptyResultHint": "Click Generate; this panel returns one tiny tag, not a report.",
  ...
  zh: {
    ...
    "home.sampleReadyHint": "示例文稿已经准备好。现在就可进入工作台，或上传你自己的 PPT。",
    ...
    "settings.testPassed": "连接正常；保存后将使用这组配置。",
    "settings.tokenPolicy": "AI 使用",
    "settings.tokenPolicyHint": "上传不会调用模型；只有测试连接、点击右侧预设或提交问题才会消耗 token。",
    ...
    "command.exportDeckMeta": "Markdown · 原始备注、提取文字、手动 AI",
    "command.empty": "没有匹配的幻灯片或操作",
    "export.generatedAt": "导出时间",
    "export.aiContent": "AI 内容",
    "export.aiOnDemand": "仅包含你手动生成过的 AI 短签或回答。",
    "export.manualAI": "手动 AI 内容",
    ...
    "stage.copyNotes": "复制讲者备注",
    "stage.notesCopied": "讲者备注已复制",
    ...
    "ai.emptyResultHint": "点击生成；这里只返回一个短词标签，不写报告。",
    "ai.onDemand": "按需",
